...
public class RenameDialog extends JFrame{
    ...
    public RenameDialog(DocumentTable documentTable) {
        ...
        renameDialogController.setDocumentTable(documentTable);
        ...
        okButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(!day.isEmpty() &&
                    ...
                    renameDialogController.renameDocument(id, Integer.parseInt(courseId),  Integer.parseInt(teacherId), startTrainigsDay, Integer.parseInt(trainignsDay));
                }
                freeJTextField();
            }
        });
